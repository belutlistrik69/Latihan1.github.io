...
<body>
    ...
    <form id="compose" name="compose" method="post" action="" enctype="multipart/form-data">
        <strong>
            <center>
                <h2 style="font-family:Georgia, 'Times New Roman', Times, serif;">ADMIN</h2>
                <hr>
                <hr>
            </center>
        </strong>
        <div class="mt-5">
            <div class="container">
                <div class="float-left mr-4">
                    <a class="btn btn-dark" href="?f=admin&m=insert" role="button">Add Data</a>
                </div><br>
                        ...
                        <?php if (!empty($row)) { ?>
                            <?php foreach ($row as $r) : ?>
                                <tr>
                                    ...
                                    <td><a a style="color:black;" href="?f=admin&m=update&id=<?php echo $r['f_id'] ?>"><button type="button" class="btn btn-outline-dark">Update</button></a></td>
                                    <td><a a style="color:black;" href="?f=admin&m=delete&id=<?php echo $r['f_id'] ?>"><button type="button" class="btn btn-outline-dark">Delete</button></a></td>
                                </tr>
                            <?php endforeach ?>
                        <?php } ?>
                    </tbody>
