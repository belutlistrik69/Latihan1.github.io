...
<body>
    ...
    <strong>
        <center>
            <h2 style="font-family:Georgia, 'Times New Roman', Times, serif;">BUKU</h2>
            <hr>
            <hr>
        </center>
    </strong>
            ...
            <table class="table table-bordered w-80">
                ...
                <tbody class="warna1">
                    ...
                    <?php if (!empty($row)) { ?> <?php foreach ($row as $r) : ?> <tr>
                                ...
                                <td><a style="color:black;" type="button" class="btn btn-outline-dark" href="?f=buku&m=update&id=<?php echo $r['f_id'] ?>">Update</a></td>
                                <td><a style="color:black;" type="button" class="btn btn-outline-dark" href="?f=buku&m=delete&id=<?php echo $r['f_id'] ?>">Delete</a></td>
                            </tr>
                        <?php endforeach ?>
                    <?php } ?>
                </tbody>
